import { AfterViewInit, ChangeDetectionStrategy, Component, ElementRef, inject, OnDestroy, OnInit, afterNextRender, signal, viewChild } from '@angular/core';
...
export class LandingPageComponent implements OnInit, AfterViewInit, OnDestroy {
  ...
  /*  Group 2: Value proposition  */
  ...
  /*  Group 3: Social proof  */
  ...
  /*  Group 4: Discover  */
  ...
  private readonly mapEl = viewChild<ElementRef<HTMLDivElement>>('landingMap');
  ...
  private initMap(): void {
    ...
    this.resizeTimer = setTimeout(() => this.map?.resize(), 200);
  }
}
